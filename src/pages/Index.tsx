...
const Index = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col !flex !min-h-screen"
          ...
          <div className="relative z-10 flex items-center min-h-[calc(100vh-4rem)]">
            <div className="container mx-auto px-6">
              <div className="max-w-5xl mx-auto text-center space-y-10">
                <div
                  data-animate="hero"
                  className="inline-flex items-center gap-3 rounded-full border border-primary/20 bg-primary/10 px-4 py-2 text-sm text-primary-foreground/80 backdrop-blur-sm"
                >
                  <span className="inline-block h-2 w-2 rounded-full bg-primary animate-ping-once" />
                  <span className="uppercase tracking-[0.3em] text-xs text-primary/80">
                    New
                  </span>
                  <span className="text-primary/90">
                    AI-powered test flows now live
                  </span>
                </div>
                ...
                >
                  Transform user reviews into automated tests
                ...
                <p
                  data-animate="hero"
                  className="mx-auto max-w-2xl text-xl text-muted-foreground/90"
                >
                  Scrape, analyze, and generate automated tests from every piece
                  of feedback. Harness our AI constellations to illuminate
                  exactly what users need next.
                </p>
                ...
                >
                  <Link to="/register">
                    <Button
                      size="lg"
                      className="bg-primary hover:bg-secondary rounded-full px-8 shadow-lg shadow-primary/25 hover:shadow-secondary/25 transition-all"
                    >
                      Start for Free
                    </Button>
                  </Link>
                  <Link to="/about">
                    <Button
                      size="lg"
                      variant="outline"
                      className="border-primary/60 text-primary hover:bg-primary hover:text-primary-foreground rounded-full px-8 transition-all"
                    >
                      Explore Platform
                    </Button>
                  </Link>
                ...
                <div data-animate="hero" className="grid gap-4 sm:grid-cols-3">
                  {[
                    ...
                    {
                      title: "87%",
                      caption: "Regression bugs caught pre-release",
                    },
                    {
                      title: "15 min",
                      caption: "Average test suite generation",
                    },
                  ].map((item) => (
                    <div
                      key={item.caption}
                      className="rounded-2xl border border-primary/15 bg-white/5 px-6 py-6 text-left backdrop-blur-sm shadow-lg shadow-primary/5 holo-card"
                    >
                      <p className="text-3xl font-semibold text-primary">
                        {item.title}
                      </p>
                      <p className="mt-2 text-sm uppercase tracking-[0.2em] text-muted-foreground/80">
                        {item.caption}
                      </p>
                    </div>
                  ))}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="feature-card bg-card border-2 border-primary/50 p-8 rounded-lg transition-all hover:shadow-xl holo-card">
                ...
                <p className="text-muted-foreground">
                  Automatically collect and process app reviews
                </p>
              </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center max-w-4xl mx-auto bg-gradient-to-r from-primary/10 via-secondary/10 to-primary/10 p-16 rounded-2xl border border-primary/20 shadow-lg shadow-primary/5">
              <h2 className="text-4xl md:text-5xl font-bold mb-8">
                Start your AI-driven testing journey today
              </h2>
              <p className="text-xl text-muted-foreground mb-10">
                Join thousands of developers revolutionizing their testing
                workflow
              </p>
              <Link to="/register">
                <Button
                  size="lg"
                  className="bg-primary hover:bg-secondary rounded-full px-12 py-6 text-lg shadow-lg shadow-primary/25 hover:shadow-secondary/25 transition-all"
                >
                  Join Free
                </Button>
              </Link>
